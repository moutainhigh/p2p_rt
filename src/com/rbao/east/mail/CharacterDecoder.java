...
public abstract class CharacterDecoder {
	...
	protected void decodeBufferPrefix(InputStream inputstream,
	...
	protected int decodeLinePrefix(InputStream inputstream,
			OutputStream outputstream) throws IOException {
		return bytesPerLine();
	}

	protected void decodeLineSuffix(InputStream inputstream,
			OutputStream outputstream) throws IOException {
	}
