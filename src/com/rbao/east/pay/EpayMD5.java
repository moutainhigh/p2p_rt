...
public class EpayMD5 {
	...
	\uFFFD\uFFFD \uFFFD\uFFFD \uFFFD 字节拷贝到output的outpos位置\uFFFD \uFFFD
	   ...
	   /* public static void main(String args[]) {
	    	//5B36899D367338EC917742A2DF68D5A5
	    	System.out.println(MD5Utils.signMap(new String[]{"11111","22222","100","http://"},"123456", "REQ"));
	    }*/
	    public static  String MD5HFB(String s) {
	    ...
	    /**
		 * 更具singType来选择具体的签名方法
		 * @param data 签名数据
		 * @param type 签名类型
		 * @param key 签名密钥
		 * @return
		 */
		public static String getSign(String data, String signType, String key,String charset) {
			String result = null;
			if ("1".equals(signType)) {
				data += "&key=" + key;
				result = MD5Encoder(data,charset);
				...
				try {
					...
					String content = sign(keyType, data,
		 ...
		 * @return
		 */
		public static String sign(String keyType, String data, PrivateKey privateKey) {
			try {
				Signature signalg = Signature.getInstance(keyType);
				signalg.initSign(privateKey);
				signalg.update(data.getBytes());
		 ...
		 * @return
		 */
		public static boolean checkMd5Sign(String data, String signMsg, String key,String charset) {
			try {
				data += "&key=" + key;
				System.out.println(data);
				String result = MD5Encoder(data,charset);
				System.out.println(result);
				System.out.println(signMsg);
				return signMsg.equals(result);
			} catch (Exception e) {
