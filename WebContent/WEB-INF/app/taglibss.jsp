...
<%
	...
	String pathWeb = request.getContextPath()+"/web";
	String pathApp= request.getContextPath()+"/mobile";
	String configjscss = path + "/common/app";
	String configjscssweb = path + "/common/web";
%>
...
<%-- <script type="text/javascript" src="${configjscssweb }/js/jquery-1.8.3.min.js"></script> --%>
