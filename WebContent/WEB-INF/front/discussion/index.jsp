					...
					<div class="ss-bao">
						<div class="ss-k">
							<div class="ss-input">
								...
								<input style="color: #000;" name="keyword" type="text" class="formIpt" id="keyword"
									title="请输入关键字" placeholder="充值、提现、手机绑定、等额本息..."
									maxlength="100" autocomplete="off">
								</form>
							</div>
							<div class="ss-anniou" id="searchBtn" style="cursor: pointer;">
								<a style="color: #fff;">搜索</a>
							</div>
						</div>
					</div>
					<div class="ss-right">
					...
					<div class="list-left">
						...
						<div class="list-nrb">
							<div class="list-nrk">
								<div class="list-topk">
									<ul>
										<li style="width: 150px;text-align:center;cursor: pointer;font-size: 16px;">
											<lable class="active" id="tab1">所有问题</lable>
										</li>
										<c:if test="${not empty FRONT_USER_SESSION }">
										<li style="width: 150px;text-align:center;cursor: pointer;font-size: 16px;">
											<span id="tab2">未读问题</span>
											<span class="dhdwt">${unReadQuestionsCount }</span>
										</li>
										</c:if>
										<li style="width: 200px;text-align:center;cursor: pointer;font-size: 16px;">
											<span id="tab3" style="width: 80px;">待回答问题</span>
											<span class="dhdwt">${notAnswerQuestionsCount }</span>
										</li>
									</ul>
								</div>
...
content =content + "</div>"
	...
	$("#tab2").click(function(){
		...
		getPageFrom(data, "getUnreadQuestionData.do", getAllQuestions, "questionList");
	});
