    ...
    <div class="J-Imx-con-L jfl">
     <div class="J-Imc-top-pic jboxsize">
       ...
       <dd>
        ...
        <ul class="clearfix">
         <li style="border-right:1px solid #ededed;" class="jboxsize"><a href="积分明细.html">积分明细</a></li>
         <li><a href="我的兑换.html">我的兑换</a></li>
        </ul>
      </div>
     ...
     <div class="J-Imx-con-R jfl jboxsize">
      <div class="J-Imxcr-top">
       <ol class="clearfix">
        <li >积分明细</li>
        <li >我的兑换</li>
        <li class="J-Imccrt-select" style="border-right:none;">积分规则</li>
       </ol>
      </div>
