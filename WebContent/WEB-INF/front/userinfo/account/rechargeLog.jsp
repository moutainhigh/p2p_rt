...
<body>
	...
	<div class="top-k">
		<div class="wydkxq-nr">
		<input type="hidden" value="tit_1_left16" id="curTitle">
...
<div class="tab_info">
	...
	<table class="siteInfoWidth1 tableDate">
            <thead>
            	<tr class="tdwait">
	                <td class="tdwait1"> 订单号</td>
					<td>支付方式</td>
	                <td class="tdwait1">交易类型</td>
	                <td >&nbsp;时间</td>
	                <td class="tdwait1">金额(￥)</td>
	                <td>状态</td>
					<td class="tdwait1">备注</td>
	                <td>操作</td>
         		</tr>
        </thead>
...
<script type="text/javascript">
	...
	function generateInvestRecordsTable(data){
		...
		var htmlStr = '<tr">';
	     ...
	     "<td>"+data.rechargeTradeNo+"</td>"+
	     "<td>"+data.rechargeRemark+"</td>"+
	     "<td>"+data.leixing+"</td>"+
