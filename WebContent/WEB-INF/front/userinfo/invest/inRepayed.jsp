...
<jsp:include page="/top.do"></jsp:include>
	...
	<div class="top-k">
		<div class="wydkxq-nr">
		<input type="hidden" value="tit_2_left6" id="curTitle">
        ...
        <table class="siteInfoWidth1 tableDate">
            <thead>
            	<tr class="tdwait">
	                ...
	                <td>借款者</td>
	                <td class="tdwait1">借款总额(元)</td>
	                <td>利息总额(元)</td>
	                <td class="tdwait1">已收本金(元)</td>
	                <td>已收利息(元)</td>
...
function subForm(){
	...
	var endTime=$("#endTime").val();
	 ...
	 getPageTable(data,"${path }/invest/inRepayingPage.do?tenderStatus="+4,generateInRepayTable,"inRepayTable");
}
