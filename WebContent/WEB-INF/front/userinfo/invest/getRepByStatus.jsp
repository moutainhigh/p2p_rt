...
<div class="center">
	<div class="top-k">
		<div class="wydkxq-nr">
		<input type="hidden" value="tit_2_left3" id="curTitle">
...
<script type="text/javascript">
	function subForm() {
		...
		getPageTable(data,
				"${path }/invest/getRepByStatusPage.do?repossessedStatus=" + 1,
				generateInRepayTable, "inRepayTable", "11");
	}
	...
	function generateInRepayTable(data) {
		...
		var htmlStr = '<tr>';
		htmlStr += "<td> <a href=${path}/invests/"+data.ebId+">" + data.borrowTitle + " </a></td>" + "<td>"
				+ toDate(data.prepareDatetime, 'yyyy-MM-dd') + "</td>" + "<td>"
				+ data.userAccount + "</td>" + "<td>" + data.currentPeriod
				+ "/" + data.totalPeriod + "</td>" + "<td>"
				+ data.prepareAmount + "</td>" + "<td>"
				+ data.repossessedCapital + "</td>" + "<td>"
				+ data.repossessedInterest + "</td>" + "<td>"
				+ data.lateInterest + "</td>" + "<td>" + data.lateDays
				+ "</td>" + "<td>" + "未收款" + "</td>"
				+ "<td><a href=${path}"+data.agreementPath+">" + xz
				+ "</a></td>";
		htmlStr += "</tr>";
		return htmlStr;
	};
