  ...
  <div class="wdzh-nrb">
    ...
    <div style="border:0;" class="wdzh-sx">
     	<div class="invest-tabs">
            <ul id="investTabs">
                <a href="javascript:tabChange(1);"><li class="jTab current"> 定存宝<!-- <span id="investPlanRecordCount" class="r5">0</span>  --></li></a>
                <a href="javascript:tabChange(2);"><li class="jTab "> 月息通<!-- <span id="contractCount" class="r5">0</span>  --></li></a>
            </ul>
        </div>
        <div class="wdzh-sx" id="investPanel">
            <div style="display: block;" id="investPlanList" class="jPanel">
...
<script type="text/javascript">
	$(function(){
		userTopHover(9);
		 var data={"tojsp":1};
		 var bidKind = $("#bidKind").val();
		 getPageTable(data,"${path }/invest/loanAgreementPage.do?bidKind="+bidKind,generateInvestRecordsTable,"investRecordsTable",6);
	})
