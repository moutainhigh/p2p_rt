...
%>
	...
	<form id="pagerForm" onsubmit="return dwzSearch(this, 'dialog');"
		action="user/${PRE_PATH_VIEW }getAllowBorrowUserList" method="post">
			...
			<table class="list" width="100%" layoutH="68" targetType="dialog">
				...
				<tbody>
					<c:forEach var="user" items="${pm.list }" >
						<tr>
							<th  align="center">
							    <input type="radio" name="checkName" uname="${user.userAccount }" value="${user.uid }"/>
							</th>
							<th  align="center">
								${user.userAccount }
							</th>
