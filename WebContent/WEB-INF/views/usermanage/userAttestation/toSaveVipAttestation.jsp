...
<body>
	<div class="pageContent">
			<form id="frm" method="post" action="attestation/o_saveVipAttestation" onsubmit="return validateCallback(this, backRequest);" class="pageForm required-validate">
				...
				<div class="pageFormContent" layoutH="56">
					...
					<p><label style="float:left; width:130px; padding:0 5px; line-height:21px;">VIP认证:</label><input type="text" readonly="readonly"  value="${vipUser.vipView }" /></p>
					<div class="divider"></div>
					...
					<p><label style="float:left; width:130px; padding:0 5px; line-height:21px;">VIP申请费用:</label><input type="text" name="sysVipRate" readonly="readonly"  value="<fmt:formatNumber value="${feeRate.sysVipRate }" pattern="#.00" type="number"/>" />
					</p><div class="divider"></div>	
					
					<p style="height:20%;width: 80%;"><label style="float:left; width:130px; padding:0 5px; line-height:21px;">备注:</label><textarea cols="30" rows="3"   name="vipRemarks"  class="required">${vipUser.vipRemarks }</textarea>
					</p><div class="divider"></div>
					
					<div id="vipDiv2" style="display: none;">
						<p><label style="float:left; width:130px; padding:0 5px; line-height:21px;">状态:</label>
								<input type="text" name="vipView" readonly="readonly" value="${vipUser.vipView}"/>
						</p><div class="divider"></div>
					</div>
					
					<div id="vipDiv1" style="display: none;">
						<p><label style="float:left; width:130px; padding:0 5px; line-height:21px;">状态:</label>
								<input name="status"  type="radio" value="1" />审核通过
								<input name="status"  type="radio" checked="checked"   value="5" />审核不通过
						</p><div class="divider"></div>
