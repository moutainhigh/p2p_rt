...
<body>
	<div class="pageContent">
			<form id="frm" method="post" action="attestation/o_saveVideoAttestation" onsubmit="return validateCallback(this, backRequest);" class="pageForm required-validate">
				...
				<div class="pageFormContent" layoutH="56">
					...
					<p><label style="float:left; width:130px; padding:0 5px; line-height:21px;">视频认证:</label><input type="text" readonly="readonly"  value="${user.viewVideo }" /></p>
					<div class="divider"></div>
					...
					<div id="videoDiv2" style="display: none;">
						<p><label style="float:left; width:130px; padding:0 5px; line-height:21px;">状态:</label>
								<input type="text" name="viewVideo" readonly="readonly" value="${user.viewVideo }"/>
						</p><div class="divider"></div>
						
					</div>
					
					<div id="videoDiv1" style="display: none;">
						<p><label style="float:left; width:130px; padding:0 5px; line-height:21px;">状态:</label>
