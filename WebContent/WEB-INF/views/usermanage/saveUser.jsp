	...
	<div class="pageContent">
			<form id="frm" method="post" enctype="multipart/form-data"  action="user/${PRE_PATH_EDIT }saveUser" onsubmit="return validateCallback(this, dialogAjaxDone);" class="pageForm required-validate">
				...
				<div class="pageFormContent" layoutH="56">
					...
					<p><label>用户名:</label><input name="userAccount" value="${user.userAccount }"  minlength="4" maxlength="16" class="required"  type="text" alt="请输入用户名" size="30"  /></p>
					<div class="divider"></div>
					
					<p><label>内部员工号:</label><input name="rtUserFlag" value="${user.rtUserFlag }"  minlength="4"    type="text" alt="请输入内部员工号" size="30"  /></p>
					<div class="divider"></div>
