...
%>
	...
	<form id="pagerForm" onsubmit="return navTabSearch(this);"
		action="borrow/${PRE_PATH_VIEW }getPaymentBorrowsList?right_id=${right_id}" method="post">
		...
		<div class="pageContent">
			...
			<c:forEach items="${righSubtList}" var="rightsub">
						...
						<c:if test="${fn:contains(rightsub.moduleUrl,'borrow/v_toBeyondsRepayExcel')}">
							<li>
								<a class="add" href="${rightsub.moduleUrl}?days=90" ><span>${rightsub.moduleName}</span>
								</a>
							</li>
						</c:if>
			...
			<table class="list" width="100%" layoutH="115">
				<thead>
					<tr>
						...
						<th width="6%" align="center">标种</th>
						<th width="5%" align="center">借款标题</th>
                        <th width="6%" align="center">利率</th>
						<th width="6%" align="center">应还时间</th>
						<th width="5%" align="center">应还金额</th>
						<th width="5%" align="center">应还利息</th>
						<th width="5%" align="center">本金</th>
						<th width="6%" align="center">还款时间</th>
						<th width="5%" align="center">逾期天数</th>
						<th width="5%" align="center">逾期利息</th>
						
					<c:if test="${'3'eq repaymentStatus }">
						...
						<th width="5%" align="center">逾期费用（元）</th>
						<th width="5%" align="center">最近催收时间</th>
					</c:if>
				...
				<tbody>
					<c:forEach var="repaymentBorrow" items="${pm.list }" varStatus="status">
						<tr  target="ids" rel="${repaymentBorrow.borrowId},${repaymentBorrow.repayId }">
							...
							<th  align="center">
							    ${repaymentBorrow.borrowTypeName}
							</th>
							<th  align="center">
                            ...
                            <th  align="center">
                                <fmt:formatNumber value="${repaymentBorrow.annualInterestRate}" pattern="#.##"/>%
                            </th>
							<th  align="center">
							...
							<th  align="center">
								${repaymentBorrow.repaymentInterest}
							</th>
							<th  align="center">
								${repaymentBorrow.repaymentPrincipal}
							</th>
							<th  align="center">
								<fmt:formatDate value="${repaymentBorrow.repaymentPaidtime}" pattern="yyyy-MM-dd HH:mm:ss"/>
							</th>
							<th  align="center">
							    ${repaymentBorrow.lateDays}
							</th>
							<th  align="center">
								${repaymentBorrow.lateInterest}
							</th>
						<c:if test="${'3'eq repaymentStatus || '4'eq repaymentStatus }">
							<th  align="center">
							...
							<th  align="center">
							    ${BORROWREPLAYMENT_ALL_REPAYMENT_STATUS[repaymentBorrow.repaymentStatus] }
							</th>
						</tr>
						</c:forEach>
				</tbody>
