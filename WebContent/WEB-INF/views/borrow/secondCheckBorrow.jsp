...
<body >
		<div class="pageContent">
			<form id="frm" method="post" enctype="multipart/form-data" action="borrow/o_secondCheckBorrow"
				...
				<div class="pageFormContent" layoutH="55">
					<fieldset>
						...
						<dl>
							...
							<dt>最低投标金额:</dt>
							<dd class="unit">
								<select name="minAmount" class="valid" disabled="disabled">						
									<option  value="50">50元</option>
									<option  value="100">100元</option>
									<option  value="150">150元</option>
									<option  value="200">200元</option>
									<option  value="300">200元</option>
						...
						<dl>
							<dt>最多投标金额:</dt>
							<dd class="unit">
							<select name="maxAmount" class="valid" disabled="disabled">
					...
					<fieldset style="height:autopx;">
							<legend>初审</legend>
							<dl class="nowrap">
								<dt>初审状态:</dt><c:if test=""></c:if>
								<dd>通过</dd> 
							</dl>
							<dl>
								<dt>初审人:</dt>
								<dd><input value="${borrow.trialUser.userAccount }"  type="text" size="20" disabled="disabled" /></dd>
							</dl>
							<dl>
								<dt>初审时间:</dt>
								<dd><input value="<fmt:formatDate value="${borrow.verifyTrialTime }" pattern="yyyy-MM-dd  HH:mm:ss" />" name="verifyTrialTime" readonly="readonly" type="text" size="20" disabled="disabled" /></dd>
							</dl>
							<dl>
								<dt>限制投标人待收款 :</dt>
								<dd>
							...
							<dl class="nowrap">
								<dt>发布时间:</dt>
								<dd><input type="text" value="<fmt:formatDate value="${borrow.publishDatetime }" pattern="yyyy-MM-dd  HH:mm:ss" />" name="publishDatetime" class="date textInput readonly valid" datefmt="yyyy-MM-dd HH:mm:ss" size="20" disabled="disabled" readonly="true" /></dd>
							</dl>
							<dl class="nowrap">
								<dt>用户等级:</dt>
								<dd>
							...
							<dl class="nowrap">
								<dt>审核备注:</dt>
								<dd><textarea class="textInput valid" name="verifyTrialRemark" disabled="disabled" readonly="readonly" rows="5" cols="45">${borrow.verifyTrialRemark}</textarea></dd>
							</dl>
						</fieldset>
						<fieldset style="height: 300px;">
							<legend>复审</legend>
								<dl class="nowrap">
									<dt>审核状态:</dt>
									<dd><input name="borrowStatus" id="borrowStatus" value="5" type="radio" />通过  &nbsp;&nbsp;&nbsp;&nbsp;<input name="borrowStatus" id="borrowStatus" checked="checked" value="11"  type="radio" />未通过</dd>
								</dl>
								<dl class="nowrap">
									<dt>审核备注:</dt>
									<dd><textarea class="textInput valid" name="verifyReviewRemark"  rows="5" cols="45"></textarea></dd>
								</dl>
							</fieldset>
						</div>
				<div class="formBar">
...
<script type="text/javascript">
	...
	$(function(){
		...
		var minWaitRepossess=${borrow.minWaitRepossess}+"";
		$("select[name='minWaitRepossess']").val(minWaitRepossess+"");
		var repaymentStyle=${borrow.repaymentStyle}+"";
		$("select[name='repaymentStyle']").val(repaymentStyle+"");
		var bidRank=${borrow.repaymentStyle}+"";
		$("select[name='bidRank']").val(bidRank+"");
	})
