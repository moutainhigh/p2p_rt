...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<form id="pagerForm" onsubmit="return navTabSearch(this);"
		action="quickBorrow/${PRE_PATH_VIEW }getList?right_id=${right_id}&audit=1" method="post">
				...
				<table class="searchContent">
					<tr>
						...
						状态：
							<select name="status">
							<c:choose>
								<c:when test="${searchParams.status eq 1 || searchParams.status eq 2 || searchParams.status eq 3  }">
			...
			<ul class="toolBar">
				<c:forEach items="${righSubtList}" var="rightsub">
						 <c:if test="${fn:contains(rightsub.moduleUrl,'quickBorrow/o_quickBorrow_audit')}">
							<li>
								<a class="edit" href="${rightsub.moduleUrl}?supportID={sid_support}&right_id=${right_id}&audit=1"
