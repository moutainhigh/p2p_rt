		...
		<div class="tabsContent">
			<div>
				<div layoutH="14" style="float:left; display:block; overflow:auto; width:240px; border:solid 1px #CCC; line-height:21px; background:#fff">      				       
				    ...
				    <li>
				    	<a href="module/v_getModuleListInfo?right_id=13&moduleId=${moduleId }" target="ajax" rel="moduleBox" >根目录</a>
				    	 ${requestScope.ModuleList }
				     </li>
				     </ul>
				     
				</div>
				<div layoutH="14" id="moduleBox" class="unitBox" style="margin-left:246px;background:#fff;">
