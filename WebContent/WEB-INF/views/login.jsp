...
<title>浩茗后台管理系统V2.0</title>
<link rel="stylesheet" href="resources/skin/js/jquery-ui.css"
...
body {
	...
	padding: 0;
	font-size: 12px;
	background:#0f579f url(<%=path %>/common/views/images/bg.jpg) top center no-repeat;
	color:#fff;
}
				...
				<td><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td width="423" height="280" valign="top" ><table
									...
									<tr>
										<td style="height:280px;"><img src="<%=path %>/common/views/images/llogo.png" /></td>
									</tr>
								</table></td>
							<td width="40" align="center" valign="bottom"></td>
							<td valign="top" style="width:362px;heigth:340px; background-image:url('<%=path %>/common/views/images/dl_bg.png');" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td height="80" align="center" ><img src="<%=path %>/common/views/images/ltitle.png" /></td>
									</tr>
									<tr>
										<td>
											...
											<table width="100%" border="0" align="center" cellpadding="0"
												...
												<tr>
													...
													<input type="image" src="<%=path %>/common/views/images/login.png" name="submit" />&nbsp; &nbsp;&nbsp;</td>
												</tr>
