...
(function() {
    ...
    function J(a, b, c) {
        ...
        else if (q(b) && da(b)) for (d in b) a.setAttribute(d, b[d]);
        return e
    }
    function sa(a) {
        return Ha(a) ? a: [a]
            ...
            init: function(b) {
                ...
                function(b, e) {
                    ...
                    e === "cur" ? f = c.prototype: e === "_default" && a.Tween && (f = a.Tween.propHooks[e], e = "set"); (g = f[e]) && (f[e] = function(a) {
                        ...
                        c.attr ? c.attr(a.prop, e === "cur" ? y: a.now) : g.apply(this, arguments)
                    })
                });
    ...
    oa = function(a) {
        ...
        return {
            get: function(c) {
                var f;
                d ? (f = A(a), f.stops = [].concat(f.stops), o(d,
                function(a, b) {
    ...
    P.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                u = u.join(",");
                h[u] ? a = h[u].attr("id") : (g.id = a = "highcharts-" + yb++, h[u] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], o(j,
                function(a) {
        ...
        applyTextShadow: function(a) {
            ...
            f ? L(b, e) : (this.fakeTS = !0, this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), o(a.split(/\s?,\s?/g),
            function(a) {
                var d = b.firstChild,
                e, f, a = a.split(" ");
        ...
        updateTransform: function() {
            ...
            a = ["translate(" + a + "," + b + ")"];
            e ? a.push("rotate(90) scale(-1,1)") : f && a.push("rotate(" + f + " " + (g.getAttribute("x") || 0) + " " + (g.getAttribute("y") || 0) + ")"); (q(c) || q(d)) && a.push("scale(" + p(c, 1) + " " + p(d, 1) + ")");
        ...
        getBBox: function(a) {
            ...
            var i, j = f.style,
            k, l;
            d !== y && (l = ["", e || 0, g && g.fontSize, f.style.width].join(","), l = d === "" || Ob.test(d) ? "num:" + d.toString().length + l: d + l);
            l && !a && (b = c.cache[l]);
            if (!b) {
                if (f.namespaceURI === Ca || c.forExport) {
                    try {
                        ...
                        La && j.textShadow ? (i = j.textShadow, j.textShadow = "") : k && k(O),
                        b = f.getBBox ? x({},
                        f.getBBox()) : {
                            width: f.offsetWidth,
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) J(f, "height", v(J(f, "height") - h, 0)),
                    f.cutHeight = h;
        ...
        zIndexSetter: function(a, b) {
            ...
            if (e) {
                ...
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++) if (e = d[i], f = J(e, "zIndex"), e !== g && (F(f) > a || !q(a) && q(f))) c.insertBefore(g, e),
                h = !0;
                h || c.appendChild(g)
            }
            return h
    ...
    P.prototype["stroke-widthSetter"] = P.prototype.strokeSetter = function(a, b, c) {
        this[b] = a;
        if (this.stroke && this[""]) this.strokeWidth = this[""],
        P.prototype.fillSetter.call(this, this.stroke, "stroke", c),
        c.setAttribute("", this[""]),
        this.hasStroke = !0;
        else if (b === "" && a === 0 && this.hasStroke) c.removeAttribute("stroke"),
        this.hasStroke = !1
    };
    var ua = function() {
    ...
    ua.prototype = {
        ...
        buildText: function(a) {
            ...
            c = this,
            d = c.forExport,
            e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = J(b, "x"), k = a.styles, l = a.textWidth, m = k && k.lineHeight, n = k && k.textShadow, u = k && k.textOverflow === "ellipsis", r = g.length, S = l && !a.added && this.box, Q = function(a) {
                return m ? F(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize: k && k.fontSize || c.style.fontSize || 12, a).h
            },
            t = function(a) {
                return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
            }; r--;) b.removeChild(g[r]); ! f && !n && !u && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, S && S.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), o(e,
            function(e, f) {
                var g, m = 0,
                ...
                function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            J(r, n);
                            b.appendChild(r); ! m && f && (!ca && d && L(r, {
                                display: "block"
                            }), J(r, "dy", Q(r)));
                            if (l) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), o = g.length > 1 || f || n.length > 1 && k.whiteSpace !== "nowrap", S, w, q, v = [], y = Q(r), s = 1, x = a.rotation, A = e, C = A.length; (o || u) && (n.length || v.length);) a.rotation = 0,
                                S = a.getBBox(!0),
                                q = S.width,
                                !ca && c.forExport && (q = c.measureSpanWidth(r.firstChild.data, a.styles)),
                                S = q > l,
                                w === void 0 && (w = S),
                                u && w ? (C /= 2, A === "" || !S && C < 0.5 ? n = [] : (S && (w = !0), A = e.substring(0, A.length + (S ? -1 : 1) * ta(C)), n = [A + (l > 3 ? "…": "")], r.removeChild(r.firstChild))) : !S || n.length === 1 ? (n = v, v = [], n.length && (s++, r = B.createElementNS(Ca, "tspan"), J(r, {
                                    dy: y,
                                    x: j
                                }), p && J(r, "style", p), b.appendChild(r)), q > l && (l = q)) : (r.removeChild(r.firstChild), v.unshift(n.pop())),
                                n.length && r.appendChild(B.createTextNode(n.join(" ").replace(/- /g, "-")));
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            p = h.style;
            delete h.style;
            H(j.element, ya ? "mouseover": "mouseenter",
            function() {
                k !== 3 && j.attr(f).css(u)
            });
            H(j.element, ya ? "mouseout": "mouseleave",
            function() {
                k !== 3 && (l = [e, f, g][k], m = [n, u, r][k], j.attr(l).css(m))
            });
            j.setState = function(a) { (j.state = k = a) ? a === 2 ? j.attr(g).css(r) : a === 3 && j.attr(h).css(p) : j.attr(e).css(n)
            };
            return j.on("click",
            function() {
                k !== 3 && d.call(j)
        ...
        fontMetrics: function(a, b) {
            ...
            if (b && K.getComputedStyle) b = b.element || b,
            a = K.getComputedStyle(b, "").fontSize;
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (E) {
                    if (!r) a = s( - Q * t) + z,
                    b = (h ? -F: 0) + z,
                    n.box = r = d ? m.symbol(d, a, b, n.width, n.height, G) : m.rect(a, b, n.width, n.height, 0, G[Pb]),
                    r.attr("fill", O).add(n);
                    r.isImg || r.attr(x({
                        width: s(n.width),
                        height: s(n.height)
        ...
        var Na = {
            ...
            init: function(a, b, c, d) {
                ...
                if (!B.namespaces.hcv) {
                    ...
                    try {
                        B.createStyleSheet().cssText1 = "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } "
                    } catch(f) {
                        B.styleSheets[0].cssText1 += "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } "
                    }
                }
            },
            isHidden: function() {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    n = m.x2 || m[2] || 0,
                    m = m.y2 || m[3] || 0,
                    t = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / ma) + '"',
                    q();
                    else {
                        var j = m.r,
                        v = j * 2,
                        ...
                        A, j = function() {
                            ...
                            t = 'src="' + T.global.VMLRadialGradientURL + '" size="' + v + "," + y + '" origin="0.5,0.5" position="' + s + "," + x + '" color2="' + Q + '" ';
                            q()
                        };
                        d.added ? j() : d.onAdd = j;
                        j = p
                    } else j = k
                } else if (g.test(a) && b.tagName !== "IMG") f = oa(a),
                h = ["<", c, ' opacity="', f.get("a"), '"/>'],
    ...
    Ta.prototype = {
        addLabel: function() {
            ...
            q(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = q(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(A(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
        },
        ...
        handleOverflow: function(a) {
            ...
            else if (d = c + (1 - i) * j, c - i * j < f ? k = a.x + k * (1 - i) - f: d > e && (k = e - a.x + k * i, l = -1), k = C(b.slotWidth, k), k < b.slotWidth && b.labelAlign === "center" && (a.x += l * (b.slotWidth - k - i * (b.slotWidth - C(j, k)))), j > k || b.autoRotation && g.styles.width) m = k;
            m && g.css({
                width: m,
        ...
        render: function(a, b, c) {
            ...
            if (m && Q) w === "inside" && (Q = -Q),
            d.opposite && (Q = -Q),
            h = this.getMarkPath(x, s, Q, m * A, g, f),
            n ? n.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(x)) i.xy = s = this.getLabelPosition(x, s, i, g, k, v, a, ga),
            this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? q = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(s),
            ga && a % ga && (q = !1),
            q && !isNaN(s.y) ? (s.opacity = c, i[this.isNew ? "attr": "animate"](s), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Qa(this, this.axis)
        }
    ...
    z.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (g) {
                ...
                if (r) t.fill = r;
                if (d.borderWidth) t.stroke = d.borderColor,
                t[""] = d.borderWidth
            } else return;
            if (q(p)) t.zIndex = p;
            if (m) if (n) m.animate({
            ...
            } else if (n && n.length && (a.svgElem = m = w.path(n).attr(t).add(), o)) for (u in d = function(b) {
                m.on(b,
                function(c) {
                    o[b].apply(a, [c])
                })
    ...
    va.prototype = {
        ...
        getSeriesExtremes: function() {
            ...
            function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && d <= 0 && (d = null);
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = C(p(a.dataMin, d[0]), Pa(d)),
                        a.dataMax = v(p(a.dataMax, d[0]), Fa(d))
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        if (q(c) && q(e)) a.dataMin = C(p(a.dataMin, c), c),
                        a.dataMax = v(p(a.dataMax, e), e);
                        if (q(d)) if (a.dataMin >= d) a.dataMin = d,
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            ...
            a = c = s(e + i);
            i = j = s(k - e - i);
            isNaN(e) ? m = !0 : this.horiz ? (i = h, j = k - this.bottom, a = c = n(a, g, g + this.width)) : (a = g, c = l - this.right, i = j = n(i, h, h + this.height));
        ...
        adjustForMinRange: function() {
            ...
            f, g, h, i, j;
            if (this.isXAxis && this.minRange === y && !this.isLog) q(a.min) || q(a.max) ? this.minRange = null: (o(this.series,
            function(a) {
                i = a.xData;
                for (g = j = a.xIncrement ? 1 : i.length - 1; g > 0; g--) if (h = i[g] - i[g - 1], f === y || h < f) f = h
        ...
        setAxisTranslation: function(a) {
            ...
            function(a) {
                ...
                h > c && (h = 0);
                d = v(d, h);
                b.single || (f = v(f, Da(j) ? 0 : h / 2), g = v(g, j === "on" ? 0 : h)); ! a.noSharedTooltip && q(u) && (e = q(e) ? C(e, u) : u)
        ...
        setTickInterval: function(a) {
            ...
            if (e) ! a && C(b.min, p(b.dataMin, b.min)) <= 0 && la(10, 1),
            b.min = ea(Ea(b.min)),
            b.max = ea(Ea(b.max));
            if (b.range && q(b.max)) b.userMin = b.min = v(b.min, b.max - b.range),
            b.userMax = b.max,
            b.range = null;
            ...
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !k && l === b.linkedParent.options.tickPixelInterval ? k = b.linkedParent.tickInterval: p(k, this.tickAmount ? (b.max - b.min) / v(this.tickAmount - 1, 1) : void 0, m ? 1 : (b.max - b.min) * l / v(b.len, l));
            g && !a && o(b.series,
            function(a) {
        ...
        setTickPositions: function() {
            ...
            this.min === this.max && q(this.min) && !this.tickAmount && (g = !0, this.min -= 0.5, this.max += 0.5),
            this.single = g,
        ...
        getTickAmount: function() {
            ...
            b, c = this.options,
            d = c.tickAmount,
            e = c.tickPixelInterval; ! q(c.tickInterval) && this.len < e && !this.isRadial && !this.isLog && c.startOnTick && c.endOnTick && (d = 2); ! d && this.chart.options.chart.alignTicks !== !1 && c.alignTicks !== !1 && (o(this.chart[this.coll],
            function(c) {
                var d = c.options,
                e = c.horiz,
        ...
        unsquish: function() {
            ...
            c ? (l = q(h) ? [h] : f < p(b.autoRotationLimit, 80) && !b.staggerLines && !b.step && b.autoRotation) && o(l,
            function(a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90) j = m(N(i.h / aa(ha * a))),
                b = j + N(a / 360),
                b < k && (k = b, g = a, e = j)
            }) : e = m(i.h);
            this.autoRotation = l;
        ...
        render: function() {
            ...
            if (r || f) {
                ...
                function(b, c) {
                    ...
                    i[b].render(c)
                }), n && (a.min === 0 || a.single))) i[ - 1] || (i[ - 1] = new Ta(a, -1, null, !0)),
                i[ - 1].render( - 1);
                m && o(g,
                function(b, c) {
                    if (c % 2 === 0 && b < a.max) k[b] || (k[b] = new z.PlotLineOrBand(a)),
                    t = b + n,
                    w = g[c + 1] !== y ? g[c + 1] + n: a.max,
                    k[b].options = {
                        from: e ? ia(t) : t,
                        to: e ? ia(w) : w,
                        color: m
    ...
    va.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (q(b)) {
            ...
            b = 1;
            if (ob || eb) i = i.getTime(),
            i = new Aa(i + Wa(i));
            h = i[Za]();
            for (var d = i.getTime(), l = i[Ya](), m = i[Xa](), n = (D.day + (g ? Wa(i) : i.getTimezoneOffset() * 6E4)) % D.day; d < c;) e.push(d),
            j === D.year ? d = gb(h + b * k, 0) : j === D.month ? d = gb(h, l + b * k) : !g && (j === D.day || j === D.week) ? d = gb(h, l, m + b * k * (j === D.day ? 1 : 7)) : d += j * k,
            b++;
            e.push(d);
            o(lb(e,
            function(a) {
                return j <= D.hour && a % D.day === n
            }),
            function(a) {
                f[a] = "day"
            })
    ...
    va.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        g = this.getLinearTickPositions(a, b, c);
            ...
            i = e.length;
            for (h = 0; h < i && !l; h++) j = Ea(ia(f) * e[h]),
            j > b && (!d || k <= c) && k !== y && g.push(k),
            k > c && (l = !0),
            k = j
    ...
    Mb.prototype = {
        ...
        getPosition: function(a, b, c) {
            ...
            u = function() {
                l.apply(0, i) !== !1 ? m.apply(0, j) === !1 && !h && (n(!0), u()) : h ? f.x = f.y = 0 : (n(!0), u())
    ...
    Va.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (z.Tooltip && b.tooltip.enabled) a.tooltip = new Mb(a, b.tooltip),
        ...
        runPointActions: function(a) {
            ...
            m,
            n;
            if (!e && !g) for (h = 0; h < c.length; h++) if (c[h].directTouch || !c[h].options.stickyTracking) c = []; ! e && g && g.directTouch && f ? m = f: (o(c,
            function(b) {
            ...
            if (m && (m !== this.prevKDPoint || d && d.isHidden)) {
                if (e && !m.series.noSharedTooltip) {
                    for (h = l.length; h--;)(l[h].clientX !== m.clientX || l[h].series.noSharedTooltip) && l.splice(h, 1);
                    l.length && d && d.refresh(l, a);
                    o(l,
                    function(b) {
                        if (b !== m) b.onMouseOver(a)
                    }); (g && g.directTouch && f || m).onMouseOver(a)
                } else d && d.refresh(m, a),
                m.onMouseOver(a);
                this.prevKDPoint = m
        ...
        reset: function(a, b) {
            ...
            f = c.hoverPoints,
            g = c.tooltip,
            h = g && g.shared ? f: e; (a = a && g && h) && sa(h)[0].plotX === y && (a = !1);
            if (a) g.refresh(h),
            e && (e.setState(e.state, !0), o(c.axes,
            function(a) {
                ...
                if (d) d.onMouseOut();
                g && g.hide(b);
                if (this._onDocumentMouseMove) Z(B, "mousemove", this._onDocumentMouseMove),
        ...
        drag: function(a) {
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !u && !this.selectionMarker) this.selectionMarker = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0).attr({
        ...
        inClass: function(a, b) {
            for (var c; a;) {
                if (c = J(a, "class")) if (c.indexOf(b) !== -1) return ! 0;
        ...
        setDOMEvents: function() {
            ...
            bb === 1 && H(B, "touchend", a.onDocumentTouchEnd)
        },
        destroy: function() {
            var a;
    ...
    x(z.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            ...
            y = !w && c[1][l],
            x,
            c = function() { ! w && N(q - s) > 20 && (p = h || N(v - y) / N(q - s));
                r = (n - v) / p + q;
    ...
    if (K.PointerEvent || K.MSPointerEvent) {
        ...
        Bb = function(a, b, c, d) {
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && Y[pa]) d(a),
            d = Y[pa].pointer,
            d[b]({
                type: c,
        ...
        function(a) {
            a.apply(this); (this.hasZoom || this.followTouchMove) && this.batchMSEvents(H)
        });
    ...
    nb.prototype = {
        ...
        renderItem: function(a) {
            ...
            if (!o) {
                ...
                a.legendItem = o = c.text("", l ? f + g: -g, this.baseline || 0, w).css(A(a.visible ? h: i)).attr({
                    align: l ? "left": "right",
                    zIndex: 2
                }).add(a.legendGroup);
            ...
            if (e && this.itemX - r + f > (m || b.chartWidth - 2 * j - r - d.x)) this.itemX = r,
            this.itemY += u + this.lastLineHeight + n,
        ...
        getAllItems: function() {
            ...
            function(b) {
                var c = b.options;
                if (p(c.showInLegend, !q(c.linkedTo) ? y: !1, !0)) a = a.concat(b.legendItems || (c.legendType === "point" ? b.data: b))
            });
            return a
        },
        ...
        handleOverflow: function(a) {
            ...
            if (a > f && !e.useHTML) {
                ...
                function(a, b) {
                    ...
                    e = n.length;
                    if (!e || c - n[e - 1] > h && (u || c) !== n[e - 1]) n.push(u || c),
                    e++;
    ...
    }; (/Trident\/7\.0/.test(Ba) || La) && cb(nb.prototype, "positionItem",
    function(a, b) {
        var c = this,
        d = function() {
    ...
    E.prototype = {
        ...
        initSeries: function(a) {
            var b = this.options.chart; (b = M[a.type || b.type || b.defaultSeriesType]) || la(17, !0);
            b = new b;
            b.init(this, a);
            return b
        },
        ...
        setTitle: function(a, b, c) {
            ...
            function(a) {
                ...
                a = a[2];
                c && e && (d[b] = c = c.destroy());
                a && a.text1 && !c && (d[b] = d.renderer.text(a.text, 0, 0, a.useHTML).attr({
                    align: a.align,
                    "class": "highcharts-" + b,
                    zIndex: a.zIndex || 4
                }).css(a.style).add())
        ...
        getContainer: function() {
            ...
            a || la(13, !0);
            c = F(J(a, "data-highcharts-chart")); ! isNaN(c) && Y[c] && Y[c].hasRendered && Y[c].destroy();
            ...
            this.renderer = b.forExport ? new ua(a, c, d, b.style, !0) : new $a(a, c, d, b.style);
        ...
        setSize: function(a, b, c) {
            ...
            if (q(a)) d.chartWidth = e = v(0, s(a)),
            d.hasUserSize = !!e;
            if (q(b)) d.chartHeight = f = v(0, s(b)); (za ? mb: L)(d.container, {
                width: e + "px",
                height: f + "px"
            },
            za);
        ...
        drawChartBox: function() {
            ...
            if (l) h ? h.animate(t) : this.plotBGImage = b.image(l, p, o, q, v).add();
            w ? w.animate({
                width: s.width,
                height: s.height
    ...
    R.prototype = {
        ...
        autoIncrement: function() {
            ...
            a = d === "month" ? +a[wb](a[Ya]() + c) : +a[xb](a[Za]() + c),
            c = a - b;
            this.xIncrement = b + c;
            return b
        },
            ...
            function(a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (ra(k)) {
                        ...
                        m += i;
                        e.xIncrement = m
                    } else if (Ha(k)) if (q) for (c = 0; c < h; c++) i = a[c],
                    u[c] = i[0],
                    r[c] = i.slice(1, q + 1);
        ...
        processData: function(a) {
            ...
            d > 0 && (g === y || d < g) ? g = d: d < 0 && this.requireSorting && la(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function() {
            ...
            b = this.data = b;
            for (m = 0; m < g; m++) i = h + m,
            j ? l[m] = (new f).init(this, [d[m]].concat(sa(e[m]))) : (b[i] ? k = b[i] : a[i] !== y && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k),
            l[m].index = i;
        ...
        getExtremes: function(a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++) if (j = c[l], k = a[l], i = k !== null && k !== y && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j) if (i = k.length) for (; i--;) k[i] !== null && (e[f++] = k[i]);
            else e[f++] = k;
            this.dataMin = Pa(e);
            this.dataMax = Fa(e)
        },
        translate: function() {
            ...
            h = !!this.modifyValue,
            i = a.pointPlacement,
            j = i === "between" || ra(i), k = a.threshold, l = a.startFromThreshold ? k: 0, m, n, u, o = Number.MAX_VALUE, a = 0; a < g; a++) {
                var s = f[a],
                x = s.x,
                t = s.y;
                n = s.low;
                var w = b && e.stacks[(this.negStacks && t < (l ? 0 : k) ? "-": "") + this.stackKey];
                if (e.isLog && t !== null && t <= 0) s.y = t = null,
                la(10);
                s.plotX = m = C(v( - 1E5, c.translate(x, 0, 0, 0, 1, i, this.type === "flags")), 1E5);
                if (b && this.visible && w && w[x]) w = w[x],
                t = w.points[this.index + "," + a],
                n = t[0],
                t = t[1],
                n === l && (n = p(k, e.min)),
                e.isLog && n <= 0 && (n = null),
                ...
                s.plotY = n = typeof t === "number" && t !== Infinity ? C(v( - 1E5, e.translate(t, 0, 1, 0, 1)), 1E5) : y;
        ...
        drawPoints: function() {
            ...
            if (l.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = V(g.plotX), e = g.plotY, k = g.graphic, n = g.marker || {},
            u = !!g.marker, a = q && n.enabled === y || n.enabled, o = g.isInside, a && e !== y && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select": ""] || m, h = a.r, i = p(n.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[o ? "show": "hide"](!0).animate(x({
                x: d - h,
                y: e - h
            },
            k.symbolName ? {
        ...
        getAttribs: function() {
            ...
            if (!j || g < j || l) for (; g--;) {
                ...
                if (j.options) for (v in m) q(c[m[v]]) && (l = !0);
                if (l) {
                    c = c || {};
                    l = [];
                    d = c.states || {};
        ...
        redraw: function() {
            ...
            this.translate();
            this.render();
            b && I(this, "updatedData"); (c || b) && delete this.kdTree
        },
        kdDimensions: 1,
        ...
        update: function(a, b, c, d) {
            function e() {
                ...
                if (da(a) && !Ha(a)) f.redraw = function() {
                    if (h) if (a && a.marker && a.marker.symbol) f.graphic = h.destroy();
    ...
    x(R.prototype, {
        addPoint: function(a, b, c, d) {
            ...
            m = i.x;
            d = u.length;
            if (e.requireSorting && m < u[d - 1]) for (n = !0; d && u[d - 1] > m;) d--;
    ...
    xa = ka(R, {
        ...
        getColumnMetrics: function() {
            ...
            f, g = {},
            h, i = 0;
            b.grouping === !1 ? i = 1 : o(a.chart.series,
            function(b) {
                var c = b.options,
                e = b.yAxis;
                if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos) c.stacking ? (f = b.stackKey, g[f] === y && (g[f] = i++), h = g[f]) : c.grouping !== !1 && (h = i++),
                b.columnIndex = h
            });
        ...
        drawPoints: function() {
            ...
            function(h) {
                var i = h.plotY,
                j = h.graphic;
                if (i !== y && !isNaN(i) && h.y !== null) f = h.shapeArgs,
                i = q(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                }: {},
                g = h.pointAttr[h.selected ? "select": ""] || a.pointAttr[""],
                j ? (db(j), j.attr(i)[b.pointCount < e ? "animate": "attr"](A(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
        ...
        animate: function(a) {
            ...
            e = {};
            if (ca) a ? (e.scaleY = 0.001, a = C(b.pos + b.len, v(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len: e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX": "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function() {
            var a = this,
            b = a.chart;
        ...
        function(e) {
            ...
            if (n && !h) e.dataLabel = n.destroy();
                ...
                v = !1;
                    ...
                    if (t.color === "contrast") w.color = d.inside || d.distance < 0 || b.stacking ? k.getContrast(e.color || a.color) : "#000000";
                    if (c) w.cursor = c;
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        l = this.visible && (a.series.forceDL || f.isInsidePlot(h, s(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g));
        if (l) d = x({
            x: g ? f.plotWidth - i: h,
                ...
                if (K) {
                    ...
                    if (m > 0) {
                        ...
                        for (G = 0; G < K; G++) {
                            ...
                            c = 9999;
                            var P, O;
                            for (O = 0; O < t; O++) P = N(I[O] - w[1]),
                            P < c && (c = P, J = O);
                            if (J < G && I[G] !== null) J = G;
                            else for (t < K - G + J && I[G] !== null && (J = t - K + G); I[J] === null;) J++;
                            M.push({
                                i: J,
                                y: I[J]
                            });
                    ...
                    for (G = 0; G < K; G++) {
                        ...
                        y.connX = B;
                        y.connY = z;
                        if (this.options.size === null) t = y.width,
                        B - t < f ? D[3] = v(s(t - B + f), D[3]) : B + t > h - f && (D[1] = v(s(B + t - h + f), D[1])),
                        z - b / 2 < 0 ? D[0] = v(s( - z + b / 2), D[0]) : z + b / 2 > i && (D[2] = v(s(z + b / 2 - i), D[2]))
                    }
                }
            }
            if (Fa(D) === 0 || this.verifyDataLabelOverflow(D)) this.placeDataLabels(),
            x && g && o(this.points,
            function(b) {
                j = b.connector;
                w = b.labelPos;
                if ((y = b.dataLabel) && y._pos && b.visible) F = y._attr.visibility,
                B = y.connX,
                z = y.connY,
                k = l ? ["M", B + (w[6] === "left" ? 5 : -5), z, "C", B, z, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", B + (w[6] === "left" ? 5 : -5), z, "L", w[2], w[3], "L", w[4], w[5]],
                j ? (j.animate({
                    d: k
    ...
    M.pie.prototype.alignDataLabel = na,
    M.pie.prototype.verifyDataLabelOverflow = function(a) {
        ...
        f < b[2] ? (b[2] = f, b[3] = /%$/.test(c.innerSize || 0) ? f * parseFloat(c.innerSize || 0) / 100 : parseFloat(c.innerSize || 0), this.translate(b), o(this.points,
        function(a) {
        ...
        b.prototype.callbacks.push(function(a) {
            function b() {
                ...
                function(a) {
                    ...
                    function(a) {
                        if (a.dataLabel) a.dataLabel.labelrank = d(a.labelrank, a.shapeArgs && a.shapeArgs.height),
                        e.push(a.dataLabel)
                    })
                });
    ...
    x(E.prototype, {
        ...
        pan: function(a, b) {
            ...
            function(b) {
                ...
                i = i > d;
                if (h.series.length && (i || l > C(k.dataMin, k.min)) && (!i || j < v(k.dataMax, k.max))) h.setExtremes(l, j, !1, !1, {
                    trigger: "pan"
                }),
                e = !0;
